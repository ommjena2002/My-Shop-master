...
import com.techchallengers.myresume.databinding.ActivityAddProductBinding
...
//        showErrorSnackBar("Image upload successfully $imageURL",false)
    ...
    private fun uploadProductDetails(){
        ...
        val shared = getSharedPreferences(Constants.MY_RESUME_PREFERENCES,Context.MODE_PRIVATE)
